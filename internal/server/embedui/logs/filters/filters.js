 ...
 *
 * Exports:
 * - ClaudiaLogs.Filters.init(ctx)
 * - ClaudiaLogs.Filters.apply()
 * - ClaudiaLogs.Filters.ensureAppOption(app)
 * - ClaudiaLogs.Filters.ensureLevelOption(lvl)
 * - ClaudiaLogs.Filters.matchesRow(ctx, tr)   // StructuredLogs tbody rows
 *
 * ctx requirements:
...
globalThis.ClaudiaLogs.Filters = {
  init: init,
