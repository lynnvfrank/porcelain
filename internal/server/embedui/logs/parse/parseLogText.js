 ...
 *
 * Exports:
 * - ClaudiaLogs.parseLogText(source, text, entryTS)
 */
...
function parseLogText(source, text, entryTS) {
  ...
  var buildDateTimeCells = globalThis.ClaudiaLogs && globalThis.ClaudiaLogs.buildDateTimeCells
    ? globalThis.ClaudiaLogs.buildDateTimeCells
    : null;
  var inferShape = globalThis.ClaudiaLogs && globalThis.ClaudiaLogs.inferShape
    ? globalThis.ClaudiaLogs.inferShape
    : null;
...
globalThis.ClaudiaLogs.parseLogText = parseLogText;
