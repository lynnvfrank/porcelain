 ...
 *
 * Exports:
 * - ClaudiaLogs.RawLogs.rebuild(ctx, opts)
 * - ClaudiaLogs.RawLogs.appendRawLine(ctx, ent, follow)
 * - ClaudiaLogs.RawLogs.copyToClipboard(ctx)
 */
...
globalThis.ClaudiaLogs.RawLogs = { rebuild: rebuild, appendRawLine: appendRawLine, copyToClipboard: copyToClipboard };
