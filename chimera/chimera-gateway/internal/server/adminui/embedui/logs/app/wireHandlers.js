...
globalThis.ChimeraLogs.App.mountWireHandlers = function (ctx) {
  ...
  var ctx.workspaceDrafts = ctx.workspaceDrafts;
  var ctx.workspaceManagedEditId = ctx.workspaceManagedEditId;
  var ctx.workspaceManagedStaging = ctx.workspaceManagedStaging;
  var ctx.adminUserDrafts = ctx.adminUserDrafts;
  var ctx.nextAdminUserDraftId = ctx.nextAdminUserDraftId;
  var ctx.adminCreatedTokenByTenant = ctx.adminCreatedTokenByTenant;
  var ctx.routingPolicyTouched = ctx.routingPolicyTouched;
  var ctx.routingPolicyDraft = ctx.routingPolicyDraft;
  var ctx.fallbackTouched = ctx.fallbackTouched;
  var ctx.routerModelsTouched = ctx.routerModelsTouched;
  var ctx.routerModelsDraft = ctx.routerModelsDraft;
  var ctx.routerThresholdTouched = ctx.routerThresholdTouched;
  var ctx.routerThresholdDraft = ctx.routerThresholdDraft;
  var ctx.routerEnabledTouched = ctx.routerEnabledTouched;
  var ctx.routerEnabledDraft = ctx.routerEnabledDraft;
  var ctx.adminRoutingEditing = ctx.adminRoutingEditing;
  var ctx.adminFallbackEditing = ctx.adminFallbackEditing;
  var ctx.adminRouterEditing = ctx.adminRouterEditing;
  var ctx.adminStateCache = ctx.adminStateCache;
