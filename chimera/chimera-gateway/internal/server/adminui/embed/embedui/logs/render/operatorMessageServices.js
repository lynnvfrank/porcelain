/**
 * Broker and vectorstore operator formatters (Phase 3). Merges into ChimeraLogs.Render operator formatters.
 */
(function () {
  ...
  function vectorstoreCollectionDisplay(collRaw, resolveColl) {
    ...
    if (globalThis.ChimeraLogs && ChimeraLogs.Derive && typeof ChimeraLogs.Derive.vectorstoreCollectionDisplay === "function") {
      var lab = ChimeraLogs.Derive.vectorstoreCollectionDisplay(r, resolveColl);
  ...
  globalThis.ChimeraLogs.Render.vectorstorePrefixFallback = vectorstorePrefixFallback;
  globalThis.ChimeraLogs.Render.isBrokerOrRelayLine = function (flat) {
  ...
  globalThis.ChimeraLogs.Render.isVectorstoreLine = function (flat) {
    if (!flat || typeof flat !== "object") return false;
    var svcName = String(flat.service || "").toLowerCase();
