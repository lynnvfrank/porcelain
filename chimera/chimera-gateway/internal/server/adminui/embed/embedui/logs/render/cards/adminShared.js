...
globalThis.ChimeraLogs.Render.Cards.mountAdminShared = function (ctx) {
  ...
  function adminProviderAvailabilityHtml(providerId, fallbackOk) {
    ...
    if (globalThis.ChimeraUI && globalThis.ChimeraUI.StatusIndicator && typeof globalThis.ChimeraUI.StatusIndicator.render === "function") {
      return globalThis.ChimeraUI.StatusIndicator.render({ label: meta.label, variantClass: meta.cls });
    }
