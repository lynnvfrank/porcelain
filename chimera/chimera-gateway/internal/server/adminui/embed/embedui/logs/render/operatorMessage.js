 ...
 * Requires ChimeraLogs.OperatorCopy (operator_copy.js) and operatorMessageServices.js.
 */
(function () {
  globalThis.ChimeraLogs = globalThis.ChimeraLogs || {};
  globalThis.ChimeraLogs.Render = globalThis.ChimeraLogs.Render || {};
  var formatters = (globalThis.ChimeraLogs.Render._operatorFormatters = globalThis.ChimeraLogs.Render._operatorFormatters || {});
  ...
  function ragCollectionSuffix(flat) {
    ...
    if (globalThis.ChimeraLogs && ChimeraLogs.Derive && typeof ChimeraLogs.Derive.vectorstoreCollectionDisplay === "function") {
      var lab2 = ChimeraLogs.Derive.vectorstoreCollectionDisplay(collRaw);
  ...
  ChimeraLogs.Render.resolveCanonicalSlug = resolveCanonicalSlug;
  ChimeraLogs.Render.operatorMessage = operatorMessage;
  ChimeraLogs.Render.operatorFriendlyGatewayMsg = operatorMessage;
})();
