 ...
 *
 * Exports:
 * - ChimeraLogs.Derive.collectIndexerRunMeta(runId, evs, opts?)
...
function collectIndexerRunMeta(runId, evs, opts) {
  ...
  if (
    ...
    rsRows = ChimeraLogs.Derive.indexerParseRootScopes(start.root_scopes);
  }
...
globalThis.ChimeraLogs.Derive.collectIndexerRunMeta = collectIndexerRunMeta;
