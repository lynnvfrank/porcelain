...
(function () {
  ...
  var bySlug = {
    ...
    "harness.stage.started": {summary: "Virtual model harness stage started."},
    "harness.stage.completed": {summary: "Virtual model harness stage completed."},
    "harness.turn.completed": {summary: "Virtual model harness turn completed with redacted envelope summary."},
    "harness.retrieval.compress_fallback": {summary: "Retrieval summarization failed, so the gateway attached truncated evidence instead."},
    "harness.scope.workspace_ambiguous": {summary: "Multiple workspaces matched the request scope; the lowest workspace id was selected."},
    "harness.stream.policy_applied": {summary: "Evaluator stream policy was applied to the virtual model chat response."},
    "harness.evaluator.failed": {summary: "Evaluator request failed, so the gateway delivered the primary response."},
    "harness.multi_draft.phase": {summary: "A multi-draft evaluator phase completed with its draft count and participating models."},
    "harness.escalation.started": {summary: "Evaluator escalation action started."},
    "harness.escalation.completed": {summary: "Evaluator escalation action completed."},
    "harness.escalation.action": {summary: "Evaluator escalation action was recorded."},
    "harness.human.paste_back_merged": {summary: "A user supplied external human answer was merged into the next harness turn."},
  ...
  var Slug = {
    ...
    MsgHarnessStageStarted: "harness.stage.started",
    MsgHarnessStageCompleted: "harness.stage.completed",
    MsgHarnessTurnCompleted: "harness.turn.completed",
    MsgHarnessRetrievalCompressFallback: "harness.retrieval.compress_fallback",
    MsgHarnessScopeWorkspaceAmbiguous: "harness.scope.workspace_ambiguous",
    MsgHarnessStreamPolicyApplied: "harness.stream.policy_applied",
    MsgHarnessEvaluatorFailed: "harness.evaluator.failed",
    MsgHarnessMultiDraftPhase: "harness.multi_draft.phase",
    MsgHarnessEscalationStarted: "harness.escalation.started",
    MsgHarnessEscalationCompleted: "harness.escalation.completed",
    MsgHarnessEscalationAction: "harness.escalation.action",
    MsgHarnessHumanPasteBackMerged: "harness.human.paste_back_merged",
