 ...
 * Parse gateway ring-buffer log lines into flat field maps for the settings UI.
 *
 * Exports:
 * - ChimeraSettings.parseLogText(source, text, entryTS)
 */
...
function parseLogText(source, text, entryTS) {
  ...
  var buildDateTimeCells = globalThis.ChimeraSettings && globalThis.ChimeraSettings.buildDateTimeCells
    ? globalThis.ChimeraSettings.buildDateTimeCells
    : null;
  var inferShape = globalThis.ChimeraSettings && globalThis.ChimeraSettings.inferShape
    ? globalThis.ChimeraSettings.inferShape
    : null;
...
globalThis.ChimeraSettings.parseLogText = parseLogText;
